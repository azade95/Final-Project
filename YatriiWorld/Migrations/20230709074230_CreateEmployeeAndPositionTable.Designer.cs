...
namespace YatriiWorld.Migrations
{
    ...
    [Migration("20230709074230_CreateEmployeeAndPositionTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YatriiWorld.Models.BookedTour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YatriiWorld.Models.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YatriiWorld.Models.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YatriiWorld.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YatriiWorld.Models.Slide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YatriiWorld.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YatriiWorld.Models.BookedTour", b =>
                {
                    ...
                    b.HasOne("YatriiWorld.Models.AppUser", "User")
                        .WithOne("BookedTour")
                        .HasForeignKey("YatriiWorld.Models.BookedTour", "UserId");
            ...
            modelBuilder.Entity("YatriiWorld.Models.Employee", b =>
                {
                    b.HasOne("YatriiWorld.Models.Position", "Position")
                        .WithMany("Employees")
